      ...
      <div className="h-full flex flex-col px-4 sm:px-8 md:px-12 lg:px-20 xl:px-48 lg:flex-row">
        ...
        <div className="h-1/2 lg:h-full lg:w-1/2 flex flex-col gap-8 items-center justify-center">
          ...
          <p>
            ...
            nostrum alias quaerat molestiae eveniet. Veritatis optio, ducimus
            officia, earum harum quo blanditiis autem est eos nemo voluptatem
            perspiciatis nihil culpa.
          </p>
