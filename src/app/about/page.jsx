        ...
        <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-32 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:w-2/3 lg:pr-0 xl:w-1/2">
          ...
          <div className="flex flex-col gap-12 justify-center">
            ...
            <p className="text-lg">
              ...
              rerum sint earum doloribus voluptatum totam beatae excepturi
              maxime, reprehenderit necessitatibus delectus natus optio rem
              tenetur, ullam eaque! Ipsa, quam suscipit!
            </p>
            {/* BIOGRAPHY QUOTE */}
          ...
          <div className="flex flex-col gap-12 justify-center pb-48">
            ...
            {/* EXPERIENCE LIST */}
            <div className=" w-3/4 xl:w-full flex flex-col">
